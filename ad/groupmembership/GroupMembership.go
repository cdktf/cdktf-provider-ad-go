...
import (
	...
	"github.com/cdktf/cdktf-provider-ad-go/ad/v6/groupmembership/internal"
...
func (j *jsiiProxy_GroupMembership) GroupMembers() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groupMembers",
...
func (j *jsiiProxy_GroupMembership) GroupMembersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"groupMembersInput",
...
func NewGroupMembership(scope constructs.Construct, id *string, config *GroupMembershipConfig) GroupMembership {
	...
	_jsii_.Create(
		"@cdktf/provider-ad.groupMembership.GroupMembership",
...
func (j *jsiiProxy_GroupMembership)SetGroupMembers(val *[]*string) {
