...
func GpoSecurity_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateGpoSecurity_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (g *jsiiProxy_GpoSecurity) AddMoveTarget(moveTarget *string) {
