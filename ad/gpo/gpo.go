...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "numericStatus", GoGetter: "NumericStatus"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-ad.gpo.GpoConfig",
		reflect.TypeOf((*GpoConfig)(nil)).Elem(),
	)
}
