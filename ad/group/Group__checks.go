...
func (j *jsiiProxy_Group) validateSetCategoryParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_Group) validateSetContainerParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Group) validateSetSamAccountNameParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_Group) validateSetScopeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
