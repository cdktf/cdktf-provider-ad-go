...
import (
	...
	"github.com/cdktf/cdktf-provider-ad-go/ad/v8/dataaduser/internal"
...
func (j *jsiiProxy_DataAdUser) Count() interface{} {
...
func (j *jsiiProxy_DataAdUser)SetCount(val interface{}) {
...
func DataAdUser_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataAdUser_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataAdUser) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataAdUser) ToHclTerraform() interface{} {
	var returns interface{}
